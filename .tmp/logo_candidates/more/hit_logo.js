...
if(text=="央广网"){
     $(this).find(".news_ly").addClass("newygw"); 
   }
   if(text=="央视新闻"){
...
if(text=="中国青年网"){
 ...
 if(text=="黑龙江广播电视台新闻联播"){
    $(this).find(".news_ly").addClass("stxwlb"); 
   }
if(text=="黑龙江广播电视台《新闻联播》"){
    $(this).find(".news_ly").addClass("stxwlb1"); 
   }
   if(text=="黑龙江经济报"){
 ...
 if(text=="新华社英文客户端"){
   ...
   if(text=="学习时报"){
    $(this).find(".news_ly").addClass("xxsb"); 
   }
    if(text=="旗帜"){
    $(this).find(".news_ly").addClass("qizhi"); 
   }
    if(text=="中国青年报客户端"){
    $(this).find(".news_ly").addClass("zgqnbkhd"); 
   }
   if(text=="中国日报新媒体"){
    $(this).find(".news_ly").addClass("shuangyu"); 
   }
  if(text=="中国日报"){
    $(this).find(".news_ly").addClass("chinarb"); 
   }
  if(text=="软科"){
    $(this).find(".news_ly").addClass("ruanke"); 
   }
  if(text=="中国新闻社"){
    $(this).find(".news_ly").addClass("chinaxinwenshe"); 
   }
  if(text=="中国报业"){
    $(this).find(".news_ly").addClass("zgby"); 
   }
  if(text=="共青团中央"){
    $(this).find(".news_ly").addClass("gqtzy"); 
   }
 if(text=="中国军网"){
    $(this).find(".news_ly").addClass("junwang"); 
   }
if(text=="香港商报"){
    $(this).find(".news_ly").addClass("xgsb"); 
   }
if(text=="奋斗者"){
    $(this).find(".news_ly").addClass("fdz"); 
   }
if(text=="中国组织人事报"){
    $(this).find(".news_ly").addClass("zgzzrsb"); 
   }
if(text=="中国人才杂志"){
    $(this).find(".news_ly").addClass("rczz"); 
   }
if(text=="中国教育在线"){
    $(this).find(".news_ly").addClass("zgjyzx"); 
   }
  });
